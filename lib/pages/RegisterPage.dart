              ...
              child: Form(
                ...
                child: Column(
                  children: [
                    ...
                    validator: notEmptyValidator,
                    decoration: customInputDecoration("EmailAnda@gmail.com"),
                    )),
                    InputLayout('Nomor HP', TextFormField(onChanged: (String value) => setState(() {
                      noHP = value;
                    }),
                    validator: notEmptyValidator,
                    decoration: customInputDecoration("+62 815125432"),
                    )),
